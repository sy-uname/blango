...
class PostApiTestCase(TestCase):
    ...
    def test_post_list(self):
        ...
        for post_dict in data:
            ...
            self.assertEqual(
                post_obj.published_at.astimezone(timezone.utc),
                datetime.strptime(
    ...
    def test_post_create(self):
        ...
        self.assertEqual(post.published_at, datetime(2021, 1, 10, 9, 0, 0, tzinfo=timezone.utc))
